...
//    }
//    vtable.values.foreach {
//      case LayoutDef(env, body) => env match {
//        case LayoutOne(name, defs) => // map to AreaUnit
//          (name -> AreaUnit(extract(defs).asInstanceOf[AttrMap]))
//        case Var(s) => // extract
//          vtable(s)
//      }
//    }
//  }
//
//  def extract(ls: List[Node]): Any = {
//    ls.map {
//      case LayoutApply(name, args) =>
//        fetchAttr(name, args)
//    }
//  }
//
